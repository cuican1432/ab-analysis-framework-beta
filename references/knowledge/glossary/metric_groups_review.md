...
- [x] Review
- Chinese description: 私信分享类型相关指标组，用于观察不同分享类型的分布与转化表现。
- English description: A DM share-type metric group used to observe the distribution and conversion of share types.
- Scope: social / DM adjacent mechanics / share
- Company core: 0
- Business core: 0
- Sub-business core: 0
- Typical usage: used to capture the distribution of DM-adjacent share types
- Priority: P2
- Common dimensions: 
- Aliases: DM Share Type; direct message share type
- Notes: Confirmed from the live Libra watched-group list; formal metric entries can be expanded later. Surface note: DM-adjacent sharing context; broader than a single DM surface.
- Review note: 
...
- [x] Review
- Chinese description: 快捷分享召回相关指标组，用于记录召回链路正式指标。
- English description: A quick-share recall metric group used to store formal metrics for the quick-share recall flow.
- Scope: social / DM adjacent mechanics / share
- Company core: 0
- Business core: 1
- Sub-business core: 1
- Typical usage: used to capture recall behavior in quick-share flows
- Priority: P1
- Common dimensions: 
- Aliases: Quick Share Recall
- Notes: Confirmed from the live Libra watched-group list; formal metric entries can be expanded later. Surface note: DM-adjacent sharing context; broader than a single DM surface.
- Review note: 
