...
notes: Use dimensions only when they are explicitly present in the raw data or source table.
```
...
typical_usage: often used as a relationship-strength supporting group in private-chat experiments
...
usage_scope: social / share
is_company_core: false
is_business_core: false
is_sub_business_core: true

typical_usage: often used as a broad internal-share supporting or guardrail group in social experiments
