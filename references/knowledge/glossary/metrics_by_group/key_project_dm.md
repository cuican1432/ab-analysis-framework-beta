...
## Metric: send_or_like_muf_message_uv/dau

```yaml
group_name: Key Project-DM
metric_name: send_or_like_muf_message_uv/dau
metric_aliases:
  - send_or_like_muf_message_uv_dau

meaning_zh: 双关私信发送或点赞渗透。
meaning_en: Penetration of social-MUF send-or-like behavior among DAU.

caliber_meaning: core DM penetration
calculation_method: DAU with at least one social-MUF send-or-like event divided by DAU.
numerator: DAU with social-MUF send-or-like activity
denominator: DAU

polarity: higher_is_better
priority_hint: P0

neighbor_metric_diff: Do not confuse with send_or_like_message_by_group_chat_uv/dau; this one is the MUF/private-chat variant.
interpretation_notes: Core reach signal for the DM/MUF family.
```

## Metric: send_or_like_muf_message_pair_cnt/dau

```yaml
group_name: Key Project-DM
metric_name: send_or_like_muf_message_pair_cnt/dau
metric_aliases:
  - send_or_like_muf_message_pair_cnt_per_dau

meaning_zh: 人均双关发送或点赞私信对数。
meaning_en: Average number of social-MUF send-or-like message pairs per DAU.

caliber_meaning: core DM relationship intensity
calculation_method: Total social-MUF send-or-like pairs divided by DAU.
numerator: total social-MUF send-or-like message pairs
denominator: DAU
...
neighbor_metric_diff: Do not confuse with send_or_like_muf_message_uv/dau; this one is pair-count based rather than penetration based.
interpretation_notes: Core relationship-strength signal for the MUF family.
```

## Metric: send_or_like_muf_message_cnt/dau

```yaml
group_name: Key Project-DM
metric_name: send_or_like_muf_message_cnt/dau
metric_aliases:
  - send_or_like_muf_message_cnt_per_dau

meaning_zh: 双关私信发送或点赞深度。
meaning_en: Average number of social-MUF send-or-like messages per DAU.

caliber_meaning: core DM interaction depth
calculation_method: Total social-MUF send-or-like message count divided by DAU.
numerator: total social-MUF send-or-like message count
denominator: DAU

polarity: higher_is_better
priority_hint: P0

neighbor_metric_diff: Do not confuse with send_or_like_muf_message_uv/dau; this one is depth-based rather than reach-based.
interpretation_notes: Core intensity signal for the MUF family.
```

## Metric: send_or_like_message_by_group_chat_uv/dau

```yaml
group_name: Key Project-DM
metric_name: send_or_like_message_by_group_chat_uv/dau
metric_aliases:
  - send_or_like_message_by_group_chat_uv_dau

meaning_zh: 群聊发送或点赞消息渗透。
meaning_en: Penetration of group-chat send-or-like behavior among DAU.

caliber_meaning: core group-chat penetration
calculation_method: DAU with at least one group-chat send-or-like event divided by DAU.
numerator: DAU with group-chat send-or-like activity
denominator: DAU

polarity: higher_is_better
priority_hint: P0

neighbor_metric_diff: Do not confuse with the social-MUF/private-chat variant; this one is explicitly group-chat based.
interpretation_notes: Core reach signal for the group-chat branch.
```
