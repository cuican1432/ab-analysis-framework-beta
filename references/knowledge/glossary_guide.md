...
## Common Metric-Type Patterns | 常见指标类型模式

- `days/days`
  - usually means behavior-day penetration over active days
- `days/user`
  - usually means average behavior days per cumulative distinct user
- `pv/user`
  - usually means per-user behavior intensity and is often suitable for additive drilldown contribution
- `uv/user`
  - usually means overall-window penetration with cross-day deduplication and should be read carefully in multi-day cumulative experiments

For stable reusable explanations of these caliber families, prefer:
