...
This page classifies the currently formalized metrics by inferred caliber family using naming-pattern heuristics plus the framework's default reading rules.
...
- `custom / other`: 18
- `custom ratio/rate`: 37
- `days/days`: 19
- `days/user`: 20
- `intensity / depth`: 85
- `penetration / coverage`: 18

## Inventory

| Group | Metric | Inferred family | Default observation principle | Reading logic |
| --- | --- | --- | --- | --- |
| Active Hours (HLT) | HLT - active hours | custom / other | metric-specific | needs direct metric-definition reading |
...
| Core-Active Days | Active Days | custom / other | metric-specific | needs direct metric-definition reading |
| Core-Active Days | Last 1-day Active Days | custom / other | metric-specific | needs direct metric-definition reading |
| Core-Active Days | Last 3-day Active Days | custom / other | metric-specific | needs direct metric-definition reading |
| Core-Active Days | Last 7-day Active Days | custom / other | metric-specific | needs direct metric-definition reading |
| Core-Active Days | Last 14-day Active Days | custom / other | metric-specific | needs direct metric-definition reading |
| Core-Active Days | Last 30-day Active Days | custom / other | metric-specific | needs direct metric-definition reading |
| Core-Key Metrics | StayDuration/U | intensity / depth | multi-day cumulative | per-user or per-active-user depth / intensity |
...
| Core-Key Metrics | Play/I | custom / other | metric-specific | needs direct metric-definition reading |
...
| Core-Publish Days | Publish Days | custom / other | metric-specific | needs direct metric-definition reading |
| Core-Publish Days | Last 1-day Publish Days | custom / other | metric-specific | needs direct metric-definition reading |
| Core-Publish Days | Last 7-day Publish Days | custom / other | metric-specific | needs direct metric-definition reading |
| Core-Publish Days | Last 30-day Publish Days | custom / other | metric-specific | needs direct metric-definition reading |
...
| [DM] DM 2-Way | Group Send or Like Message 2-Way/ User | custom / other | metric-specific | needs direct metric-definition reading |
| [DM] DM 2-Way | Muf Send or Like Message 2-Way/ User | custom / other | metric-specific | needs direct metric-definition reading |
| [DM] DM 2-Way | Send or Like Message 2-Way/ User | custom / other | metric-specific | needs direct metric-definition reading |
...
| DM Core | Stay Duration/User | intensity / depth | multi-day cumulative | per-user or per-active-user depth / intensity |
...
| [DM] DM Core Performance - Android | chat_list_frame_drop_level_4 | custom / other | metric-specific | needs direct metric-definition reading |
...
| [DM] DM Negative Feedback | click_report_user/user | intensity / depth | multi-day cumulative | per-user or per-active-user depth / intensity |
...
| [DM] DM Permission | on_to_off_user/user | intensity / depth | multi-day cumulative | per-user or per-active-user depth / intensity |
| [DM] DM Permission | unknown_to_off_user/user | intensity / depth | multi-day cumulative | per-user or per-active-user depth / intensity |
| [DM] DM Permission | off_to_on_user/user | intensity / depth | multi-day cumulative | per-user or per-active-user depth / intensity |
...
| DM Voice Message | Voice Message duration/user | intensity / depth | multi-day cumulative | per-user or per-active-user depth / intensity |
...
| DM Voice Message | Play in Entry/Record Proportion pv/pv | custom / other | metric-specific | needs direct metric-definition reading |
...
| DM Voice Message | Cancel/Record Proportion | custom / other | metric-specific | needs direct metric-definition reading |
...
| Key Project-DM | send_or_like_muf_message_uv/dau | intensity / depth | multi-day cumulative | per-user or per-active-user depth / intensity |
| Key Project-DM | send_or_like_muf_message_pair_cnt/dau | intensity / depth | multi-day cumulative | per-user or per-active-user depth / intensity |
| Key Project-DM | send_or_like_muf_message_cnt/dau | intensity / depth | multi-day cumulative | per-user or per-active-user depth / intensity |
| Key Project-DM | send_or_like_message_by_group_chat_uv/dau | intensity / depth | multi-day cumulative | per-user or per-active-user depth / intensity |
